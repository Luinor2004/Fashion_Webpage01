        ...
        <div className="bg-slate-800 border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
            ...
            <form className="" action="" method="">
                <div className="relative my-6">
                    ...
                    <label htmlFor="" className="absolute text-md text-[#224F34] duration-300 transform translate-y-[-15px] scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your Email</label>
                ...
                <div className="relative my-6">
                    ...
                    <label htmlFor="" className="absolute text-md text-[#224F34] duration-300 transform translate-y-[-15px] scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your Password</label>
